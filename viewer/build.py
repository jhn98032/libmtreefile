#!/usr/bin/env python3
#
# Written by Johan Henriksson. Copyright (C) 2014-2025.
#
import sys
import os
import subprocess
...
def dump_usage():
    ...
    print("      --debugbuild      Build with debug symbols")
            ...
            for srcdir in srcDirList:
                ...
                if not os.path.exists("Makefile"):
                    ...
                    if verifyVersion(qtVer, buildcfg.MIN_QT_VER):
                        ...
                        if not buildcfg.g_verbose:
                            qmakeCallCmds += ["CONFIG+=silent"]
                        if buildcfg.g_debugBuild:
                            qmakeCallCmds += ["CONFIG+=debug"]
